...
***Abbildung:** Datenmodelle im Vergleich: Key-Value, Key-Column, Key-Document und Key-Container* [3.2.8] <!--Abbildung noch nummerieren (gilt auch für alle weiteren Abbildungen)-->
