...
TimescaleDB ist ein relationales Open-Source Datenbankmanagementsystem für Zeitreihendaten. Das System setzt SQL ein und ist damit genauso leicht bedienbar wie herkömmliche relationale Datenbanken. Zusätzlich skaliert es aber auf eine Weise, wie es ansonsten nur bei NoSQL-Datenbanken möglich ist [3.3.1].
...
<!-- hier sollten wir vllt. nach einem gleichen Schema die Programmiersprachen aufzählen. Grit hat anschließend in diesem Unterkapitel erwähnt welche Abfragesprache unterstütz wird. Sollten wir vllt. auch machen. ich hab das bisher ganz am Anfang erwähnt -->
