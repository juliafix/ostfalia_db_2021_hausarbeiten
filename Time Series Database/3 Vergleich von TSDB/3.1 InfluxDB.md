...
Damit eine effiziente Speicherung der unterschiedliche Zeitreihenserien erfolgt, werden die Datenelemente in zeitstrukturierten Merge-Tree- (engl. TSM) und Zeitreihenindex- (engl. TSI) Dateien hinterlegt. Eine TSM Datei besteht aus den in Abbildung X dargestellten vier Abschnitten [3.1.2].

![Struktur TSM](../images/aufbau_tsm_file.png) 
Abbildung X: Struktur von TSM [3.1.2](Literaturverzeichnis.md)
