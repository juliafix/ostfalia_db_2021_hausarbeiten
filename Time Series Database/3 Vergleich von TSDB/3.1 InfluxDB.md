...
InfluxDB wurde im Jahr 2013 entwickelt und ist mittlerweile einer <!--eine statt einer -->der am weitesten verbreitete TSDB. InfluxDB ist eine NOSQL TSDB und eine Open-Source Datenbank. 
...
InfluxDB wurde speziell für die Verarbeitung von riesige Mengen an zeitindexierten Daten, die z.B. von IoT-Geräten erzeugt werden, entwickelt.  
Die Grundidee von InfluxDB ist das Speichern von Zeitreihen sowie insbesonders die Verfolgung von Metriken und Ereignissen von Geräten und Diensten im Zeitverlauf.
...
Für die Timestamps werden als Spalte _time die Daten mit einem Zeitstempel indexiert. Die Auflösung der timestamps ist variabel und kann bis zu einer Nanosekunde reichen.<!--vielleicht eher dauern statt reichen -->

Damit eine effiziente Speicherung der unterschiedlichen Zeitreihenserien erfolgt, werden die Datenelemente in zeitstrukturierten Merge-Tree- (engl. TSM) und Zeitreihenindex- (engl. TSI) Dateien hinterlegt. Eine TSM Datei besteht aus den in Abbildung 3.1.1 dargestellten vier Abschnitten [3.1.2].
