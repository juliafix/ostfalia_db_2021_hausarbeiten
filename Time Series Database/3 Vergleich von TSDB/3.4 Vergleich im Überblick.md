...
| Besonderheiten                    | Sharding und TSM + TSI Dateien, Hohes Maß an Flexibilität      | hybride Cluster-Architektur, <br />Key-Container-Datenmodell  | Relationale Datenbank in Verbindung mit einer Zeitreihendatenbank    | 
